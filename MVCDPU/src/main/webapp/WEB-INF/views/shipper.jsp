						...
						<input type="hidden" id = "addUpdateFlag" value = "" />					
					      ...
					      <div class="modal-content">
					        <div class="modal-header">
					          ...
					          <h4 class="modal-title"><p id ="modelTitle">Add Shipper</p></h4>
					        </div>
									...
									<div class="form-group">
										<div class="row">
											<div class="col-sm-6">
												...
												<input type="text" class="form-control" placeHolder="Enter Location" id="location" name="location" value="" autofocus />
											</div>
											</div>
											<div class="col-sm-6">
												<div class="input-group">
										...
										<div class="row">
											<div class="col-sm-6">
												<div class="input-group">
													...
													<input type="text" class="form-control" placeHolder="Enter Province/State" id="province" name="province" value="" />
												</div>
											</div>	
											<div class="col-sm-6">
												<div class="row">
